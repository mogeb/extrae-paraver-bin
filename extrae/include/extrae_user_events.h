...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/include/extrae_user_events.h $
 | @last_commit: $Date: 2014-02-05 17:54:10 +0100 (Wed, 05 Feb 2014) $
