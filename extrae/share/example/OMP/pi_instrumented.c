...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/example/LINUX/OMP/pi_instrumented.c $
 | @last_commit: $Date: 2013-02-27 14:47:01 +0100 (Wed, 27 Feb 2013) $
