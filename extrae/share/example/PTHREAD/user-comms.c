...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/example/LINUX/PTHREAD/user-comms.c $
 | @last_commit: $Date: 2013-04-11 09:25:18 +0200 (Thu, 11 Apr 2013) $
