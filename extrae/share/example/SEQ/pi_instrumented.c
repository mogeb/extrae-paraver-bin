...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/tags/3.2/3.2.1/example/LINUX/SEQ/pi_instrumented.c $
 | @last_commit: $Date: 2013-05-17 12:32:11 +0200 (Fri, 17 May 2013) $
